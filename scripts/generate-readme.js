    ...
    request.get(url).on('response', response => {
      ...
      response.on('end', () => {
        try {
          ...
          var difficulty = $('.question-info.text-primary ul')[0].children[9].children[1].children[0].data;
